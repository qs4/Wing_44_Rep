...
//public class setValuesPointsSplineSparcapEinfachtrapezflügel extends JavaRule {
//
//	@Override
...
////					.getValue();
//			double la = sparcap.getSparcaps1().getStructuralElement().getWing_44_structuralelement().getLa()
//					.getValue();
//			double pfeilung = sparcap.getSparcaps1().getStructuralElement().getWing_44_structuralelement().getPfeilung()
//					.getValue();
//			double spannweite = sparcap.getSparcaps1().getStructuralElement().getWing_44_structuralelement().getSpannweite()
//					.getValue();
...
//			double a =  Math.sin(Math.toRadians(pfeilung)) * (spannweite / 2)+(li / 4)-(la/4);
//			
//			double prozent = 0;
//
...
//					.getAnzpoint();
//			System.out.println("anzpoints " + anzpoints);
//
...
//							controlpointsparcap[1].setX(x_0+0.1);
//
...
//						controlpointsparcap[1].setZ(z_0+0.1); // Punkt 0 -> siehe PolyLine Sparcap
